...
public class UIVirtualDragZone : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    [System.Serializable]
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        OutputPointerEventValue(positionDelta * magnitudeMultiplier);
